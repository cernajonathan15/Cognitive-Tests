...
# ============================================================
# FOCUSED ATTENTION MEDITATION TASK
...
TASK_NAME = "focused_attention"
MEDITATION_TYPE = "FocusedAttention"
...
def clean_block(value):
    ...
    return value or "FocusedAttention"
...
exp_info = {
    ...
    "visit": "B",
    "block": "FocusedAttention",
    "date_YYYYMMDD": today_yyyymmdd
}

dlg = gui.DlgFromDict(dictionary=exp_info, title="Focused Attention Task")
if not dlg.OK:
    core.quit()
...
instructions = visual.TextStim(
    ...
    text=(
        ...
        "For this block, choose one object of meditation. This could be the breath, bodily sensations, "
        "or another simple object of attention. Keep your attention on that object as steadily as you can.\n\n"
        "Whenever you notice that your mind has wandered, press the red/right button once. "
        "Then gently return your attention to the object of meditation.\n\n"
        "There is no right or wrong number of button presses. The button press simply marks the moment "
        "when you noticed mind wandering and began shifting attention back.\n\n"
        "Please do this non-judgmentally. If the mind wanders, that is completely okay. "
        "Notice it, press the red/right button, and gently return to the object of focus.\n\n"
        "To help maintain keen awareness, you may use a noting technique. This means silently using "
        "words to keep track of your object of focus. They should sound like whispers in your mind. "
        "Examples include counting from 1 to 10 during the inhale or exhale cycle of the breath, "
        "or saying 'in and out'.\n\n"
...
# 1. ADDED: Define fixation crosshairs matching your motor control paradigm
fixation = visual.TextStim(win, text="+", color="white", height=0.08)

end_text = visual.TextStim(
    win,
    text="Focused Attention Meditation Complete\n\nResearcher: press SPACE to exit.",
    color="white",
    height=0.04,
    wrapWidth=1.25,
    pos=(0, 0),
...
# 2. CHANGED: Swapped 'in_progress_text' out for the static crosshairs stimulus
fixation.draw()
win.flip()
